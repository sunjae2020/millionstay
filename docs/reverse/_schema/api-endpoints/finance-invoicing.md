...
- → [`finance-payments.md`](./finance-payments.md) (PENDING) — Stripe webhook will close E8's open question on `payment_failed`/`refunded`/`disputed` propagation (CF-010 anchor on the payments side).
