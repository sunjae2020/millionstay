...
> **🎯 T006 GROUP COMPLETE**: 2026-04-27 — `_design/` 4 files REWRITE (design-tokens 70 + component-library 71 + guest-portal-layout 87 + admin-layout 89 = **317 lines**, T001 시점 366L → −13% 컴팩트). 25 CFs UI-side cross-ref 6 anchor + 5 cross-pack carrier. R-REPO-6 = **15회** (사용자 자발적 verification 의무 = 즉시 해소형 첫 occurrence; (가) 채택). R-REPO-9 차단 = **4회 unchanged** + 자동 = **9회**. R-REPO-10 묶음 = **7회** (T006 = 4 sub-task = T004 동률 max 가속 -83% / -75% / -75%).
> **🎯 T005 GROUP COMPLETE**: 2026-04-27 — `_workflows/` 6 files REWRITE (booking-lifecycle 70 + payment 78 + checkin-checkout 79 + agent-commission 74 + maintenance 81 + promotion 56 = **438 lines**, T001 시점 677L → −35% 컴팩트). 25 CFs + 11 incidentals 모두 anchor/cross-ref 배치. R-REPO-6 = **14회** (사용자 가설 6/6 = 100% file 명 drift; corrected (α) 채택). R-REPO-9 차단 = **4회** + 자동 = **8회**. R-REPO-10 묶음 = **6회** (T005 = 6 sub-task max 가속 −83% / −83% / −83%; T003 묶음 4 + T004 동률 max).
> **🎯 T004 GROUP COMPLETE**: 2026-04-27 — `_rules/` 4 files REWRITE (architecture 128 + financial 168 + security 210 + no-magic 136 = **642 lines**, T001 시점 420L → +53% / 예측 1000-1400 −36% 컴팩트). 25 CFs × 4 _rules anchor 매트릭스 종합 / 11 incidentals routing / Phase 2 7-step prescription summary. CF count P0=4 / P1=18 / P2=3 = **25** unchanged (T004 전체 0 NEW promotion). R-REPO-6 = **13회** (T004 Step 1 NEW→REWRITE 단순 정정). R-REPO-9 자동 진행 = **7회** (T004 차단 0). R-REPO-10 묶음 = **5회** (T004 = 4 sub-task max 가속 -83% / -75% / -75%).
...
*End of `INDEX.md` — last updated 2026-04-27 (🎯 **T008 GROUP COMPLETE — 100% PROJECT COMPLETE** — `README.md` REWRITE (97L NR → ~330L, 11 § entry point) + 8 stale T001 files 🪦 ARCHIVED (00-feature-gap + 00-overview + api-endpoints + erd-{crm,finance,operations} + domain-model + tech-stack = F16 일괄) + verify (READ-ONLY) inline (README §10 + CRITICAL_FINDINGS T008 marker mirror) / R-REPO-10 묶음 위임 **9회째 stable** (2 ST / 1 응답 = -50%; T007 8 ST -87.5% max holder 유지) / R-REPO-9 자동 진행 11회째 (F16 expansion 발견 후 R-REPO-7 (c) 자체 검증 즉시 (다) ARCHIVED 일괄 채택 → 차단 미발동) / R-REPO-6 17회째 메타-가동 (즉시 해소형 3회째 정착 — T006+T007+T008 패턴 영구 confirm) / **F17/F18 신규 incidentals** (F17 = `_T002_PROGRESS.md` 위치 drift CF-016 sub-pattern memo / F18 = 4 file line count 보고 vs actual drift -45L~-174L; final actual = README §3 ground truth) / 누적 R-REPO-5 = 11 → **14** (+F16/F17/F18) / counts unchanged P0=4 P1=18 P2=3 = 25 / **🎯 100% PROJECT COMPLETE — 71 files / 20,363L / 25 CFs / 14 incidentals / 9 R-REPO 운영 규칙 / Phase 2 .NET baseline 완성**).*
