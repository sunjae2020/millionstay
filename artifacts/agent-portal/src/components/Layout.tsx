...
import { LayoutDashboard, BookOpen, Building2, DollarSign, LogOut, User, ChevronRight } from "lucide-react";
        ...
        <div className="p-6 border-b border-sidebar-border">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-xs text-sidebar-accent-foreground">Agent Portal</div>
            </div>
          </div>
        </div>
