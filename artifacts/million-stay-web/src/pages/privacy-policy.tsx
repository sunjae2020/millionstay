...
const SECTIONS = [
  {
    ...
    body: `T/A ${APP_NAME} ("${APP_NAME}", "we", "our", "us") is committed to protecting your privacy in accordance with the Privacy Act 1988 (Cth) and the 13 Australian Privacy Principles (APPs). This Privacy Policy explains the kinds of personal information we collect, how we hold it, the purposes for which we collect, hold, use and disclose it, how you may access or correct it, how to make a complaint, and whether we are likely to disclose information to overseas recipients. This policy is openly available on our website and we encourage you to read it before using our services.`,
  },
  {
    number: "02",
