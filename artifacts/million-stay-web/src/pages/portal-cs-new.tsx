...
import { ArrowLeft, Send, Paperclip, X, Loader2, ImageIcon } from "lucide-react";
...
export default function PortalCsNew() {
  ...
  if (!token) { navigate("/login?redirect=/portal/cs/new"); return null; }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-8">
        <button onClick={() => navigate("/portal/cs")} className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-primary mb-6 transition-colors">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex gap-3 pt-2">
              <Button type="button" variant="outline" onClick={() => navigate("/portal/cs")} className="flex-1">Cancel</Button>
