...
export default function HomestayComingSoon({ title = "Coming soon" }: { title?: string }) {
  return (
    <HomestayLayout title={title}>
      <section className="max-w-3xl mx-auto px-5 py-24 md:py-32 text-center">
        ...
        <h1 className="mt-4 text-3xl md:text-4xl font-bold" style={{ fontFamily: HS_FONT.head, color: HS.darkBrown }}>{title}</h1>
        <p className="mt-3 text-gray-600">
          This part of Million Homestay is on its way. Host families can apply today, and you're welcome
