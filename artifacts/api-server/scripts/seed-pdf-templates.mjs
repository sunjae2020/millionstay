...
const TEMPLATES = [
  ...
  {
    key: "pdf.move_out_confirmation", name: "Move-out Settlement Confirmation — PDF document", category: "Documents",
    vars: { ref: { type: "string" }, refund_amount: { type: "string" }, deposit_amount: { type: "string" }, contact_phone: { type: "string" }, door_password: { type: "string" }, unit: { type: "string" }, tenant_name: { type: "string" } },
