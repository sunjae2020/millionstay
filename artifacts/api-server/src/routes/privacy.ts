  ...
  if (!payload) {
    res.status(400).type("html").send(
      renderPage(
        ...
        `<p>This unsubscribe link is no longer valid. Please open the most recent email from us and use the link inside, or contact <a href="mailto:privacy@millionstay.com.au">privacy@millionstay.com.au</a>.</p>`,
        "#dc2626",
      ),
    );
    return;
  ...
  try {
    ...
    res.status(500).type("html").send(
      renderPage(
        ...
        `<p>We couldn't process your request right now. Please try again later or email <a href="mailto:privacy@millionstay.com.au">privacy@millionstay.com.au</a>.</p>`,
        "#dc2626",
      ),
    );
  }
