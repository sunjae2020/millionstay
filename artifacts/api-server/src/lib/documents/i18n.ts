...
const LABELS: Dict = {
  ...
  "moveout.guide.refund.docs":  {
    en: "Documents required: 1 copy of the bankbook / account details in the tenant's name.",
    ko: "제출 서류: 계약자 명의 통장 사본 1부",
    zh: "所需材料：承租人名下存折复印件 1 份",
    ja: "提出書類：契約者名義の通帳の写し 1 部",
    th: "เอกสารที่ต้องส่ง: สำเนาสมุดบัญชีในชื่อผู้เช่า 1 ฉบับ",
    vi: "Hồ sơ cần nộp: 1 bản sao sổ/thông tin tài khoản đứng tên người thuê.",
  },
  "moveout.guide.refund.how":   {
    en: "How to submit: hand it in at the management office, or send it to {phone}.",
    ko: "제출 방법: 관리사무소 방문 제출 또는 {phone} 문자전송",
    zh: "提交方式：到管理办公室递交，或发送至 {phone}。",
    ja: "提出方法：管理事務所へのご持参、または {phone} へのSMS送信",
    th: "วิธีส่ง: ยื่นที่สำนักงานนิติบุคคล หรือส่งมาที่ {phone}",
    vi: "Cách nộp: nộp tại văn phòng quản lý hoặc gửi tới {phone}.",
  },
  "moveout.guide.refund.howNoPhone": {
    en: "How to submit: hand it in at the management office.",
    ko: "제출 방법: 관리사무소 방문 제출",
    zh: "提交方式：到管理办公室递交。",
    ja: "提出方法：管理事務所へのご持参",
    th: "วิธีส่ง: ยื่นที่สำนักงานนิติบุคคล",
    vi: "Cách nộp: nộp tại văn phòng quản lý.",
  },
  ...
  "moveout.guide.restore.b1Pin": {
    ...
    vi: "Đổi mật khẩu cửa về {pin} và trả toàn bộ thẻ từ, điều khiển thiết bị cho văn phòng quản lý.",
  },
  "moveout.guide.restore.b1": {
    ...
    vi: "Nếu đã đổi mật khẩu cửa hãy khôi phục, đồng thời trả thẻ từ, chìa khóa và điều khiển cho văn phòng quản lý.",
  },
