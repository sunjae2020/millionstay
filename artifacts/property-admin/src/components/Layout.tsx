  ...
  const sections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/finance/fixed-assets", label: t("nav.fixed_assets"), icon: Package },
        { href: "/finance/period-close", label: t("nav.period_close"), icon: Lock },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/settings/sms", label: t("nav.sms_center"), icon: MessageSquareText },
