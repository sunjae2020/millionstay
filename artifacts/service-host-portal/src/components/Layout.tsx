...
import { LayoutDashboard, Briefcase, CalendarDays, DollarSign, LogOut, User, ChevronRight } from "lucide-react";
        ...
        <div className="p-6 border-b border-sidebar-border">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-xs text-sidebar-accent-foreground">Service Host Portal</div>
            </div>
          </div>
        </div>
