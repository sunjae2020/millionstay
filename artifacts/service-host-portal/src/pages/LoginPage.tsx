...
const DEMO_ACCOUNTS = [
  { label: "Demo Service Host", email: "host@millionstay.com.au", password: "Host@2026!" },
];
        ...
        <div className="relative z-10 space-y-7">
          <div>
            <h2 className="text-[2.4rem] font-bold text-white leading-[1.2]">
              ...
              every <span style={{ color: BRAND }}>job.</span>
            </h2>
            <p className="text-white/45 text-sm mt-4 leading-relaxed max-w-[280px]">
              View your assigned jobs, manage your schedule, and track your earnings — all in one place.
            </p>
          </div>

          <div className="flex gap-10">
            {[
              { num: "1k+", label: "Jobs Done" },
        ...
        <div className="flex-1 flex items-center justify-center px-6 pb-12">
          <div className="w-full max-w-[400px]">
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-500 text-sm mt-1">Sign in to view your jobs & schedule</p>
            </div>
            ...
            <div className="mt-6 pt-5 border-t border-slate-200 text-center">
              <p className="text-center text-xs text-slate-400">
                Secure access · MillionStay Service Host Portal
              </p>
            </div>
          </div>
        </div>
