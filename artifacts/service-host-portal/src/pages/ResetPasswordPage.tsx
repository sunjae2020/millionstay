      ...
      <div className="w-full max-w-[420px] bg-white rounded-2xl shadow-md p-8 space-y-6">
        ...
        {done ? (
          <div className="space-y-4 text-center">
            ...
            <p className="text-slate-700 text-sm">{t("reset.done")}</p>
            <button
              onClick={() => setLocation("/")}
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <Link href="/"><a className="block text-center text-sm text-slate-500 hover:text-slate-700">{t("reset.back_to_login")}</a></Link>
          </form>
        )}
      </div>
    </div>
