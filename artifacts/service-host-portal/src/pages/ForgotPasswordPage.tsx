        ...
        {submitted ? (
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="block text-sm font-medium text-slate-700">{t("forgot.email")}</label>
            ...
            >
              {loading ? <><Loader2 className="h-4 w-4 animate-spin" /> {t("forgot.sending")}</> : t("forgot.send")}
            </button>
            <Link href="/">
